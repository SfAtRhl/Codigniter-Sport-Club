...
class Common_lib
{
    ...
    {
        echo '<header class="bg-white border-b border-gray-300">
    <div class="container mx-auto p-4 flex items-center justify-between">
        ...
        <ul class="hidden lg:flex space-x-4">
            <li class="menu-item border-2 border-orange-500 hover:bg-orange-500 rounded-md py-2 px-4 text-gray-800  hover:text-white"><a href="#" class="">Connecter</a></li>
            <li class="menu-item border-2 border-orange-500 hover:bg-orange-500 rounded-md py-2 px-4 text-gray-800  hover:text-white"><a href="#" class="">Inscrire</a></li>
        </ul>
    </div>
</header>';
    }
    ...
    {
        echo '<footer class="bg-orange-300">

    <div class=" flex flex-col md:flex-row justify-around mx-auto lg:px-32 px-16 md:pt-10 md:pb-5 space-y-2 " id="Contact">
        <div>
            <img src="img/svg/logo.svg" class="block h-20 lg:mr-8 md:mr-4" alt="" />
        </div>


        <div class=" flex flex-col">
            <div class="font-semibold md:text-xl lg:text-lg text-md md:text-black text-white pb-2">Entreprise</div>
            <div class="pl-4">
                <div class="font-semibold text-sm lg:text-md  md:text-gray-500 text-white hover:text-black"><a href="#Nous">À
                        propos de nous</a></div>
            </div>
        </div>
        <div class=" flex flex-col">
            <div class="font-semibold md:text-xl lg:text-lg text-md  md:text-black text-white pb-2">Contact Us</div>
            <div class="pl-4">
        ...
        <div class="flex flex-col">
            <div class="font-semibold md:text-xl text-lg text-black pb-2">Social</div>
            <div class="pl-4">
                <div class="flex justify-center space-x-2 ">
                    <!-- Link 1 -->
                    <a href="#">
                        <img src="img/svg/icon-facebook.svg" alt="" class="lg:h-8 md:h-6 fill-current text-black md:brightness-100 md:invert brightness-0 " />

                    </a>
                    <!-- Link 2 -->
                    <a href="#">
                        <img src="img/svg/icon-youtube.svg" alt="" class="lg:h-8 md:h-6  rounded-full md:brightness-100 brightness-0 md:invert" />
                    </a>
                    <!-- Link 3 -->
                    <a href="#">
                        <img src="img/svg/icon-twitter.svg" alt="" class="lg:h-8 md:h-6 filter md:brightness-100 brightness-0 md:invert" />
                    </a>
                    <!-- Link 4 -->
                    <a href="#">
                        <img src="img/svg/icon-pinterest.svg" alt="" class="lg:h-8 md:h-6  rounded-full md:brightness-100 brightness-0 md:invert" />
                    </a>
                    <!-- Link 5 -->
                    <a href="#">
                        <img src="img/svg/icon-instagram.svg" alt="" class="lg:h-8 md:h-6  rounded-lg md:brightness-100 brightness-0 md:invert" />
                    </a>
                </div>
            </div>
        </div>
